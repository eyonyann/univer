...
extern void enter()
{
		...
		for (int i = 0; i < number_of_flights; i++)
		{
			...
			cin >> flights[i].destination_name;
			containsOnlyLetters(flights[i].destination_name);
			cout << "Enter " << i + 1 << " flight type " << endl;
			cin >> flights[i].flight_type;
			containsOnlyLetters(flights[i].flight_type);
			cout << "Enter " << i + 1 << " flight num " << endl;
			cin >> flights[i].flight_num;
			check_int(flights[i].flight_num);
		}
		cout << endl;
